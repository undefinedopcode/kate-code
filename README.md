...
Follow the instructions at https://github.com/agentclientprotocol/claude-agent-acp to install the ACP binary.
...
- Integrates with [claude-agent-acp](https://github.com/agentclientprotocol/claude-agent-acp) by Agent Client Protocol
